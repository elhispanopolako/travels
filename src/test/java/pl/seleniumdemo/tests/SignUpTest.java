...
public class SignUpTest extends BaseTest {
    ...
    @Test
    public void signUpFluentTest() {
        String lastname = "Woźniak";
        int randomNumber = (int) (Math.random() * 1000);
        String email = "tadeo" + randomNumber + "tester@gmail.com";
        LoggedUserPage loggedUserPage = new HotelSearchPage(driver).openSignUp()
                .setName("Tadeusz", lastname)
                .setContact(email, "792159500")
                .setPassword("test123")
                .setSubmitBtn();
        Assert.assertTrue(loggedUserPage.getHeadingText().contains(lastname));
        Assert.assertEquals(loggedUserPage.getHeadingText(), "Hi, Tadeusz Woźniak");
    ...
    @Test
    public void signFluentWithFailEmail() {
        String lastname = "Woźniak";
        int randomNumber = (int) (Math.random() * 1000);
        String email = "tadeo" + randomNumber + "tester@gmail.com";
        SignUpPage signUpPage = new HotelSearchPage(driver).openSignUp().setName("Tadeusz", lastname)
                .setContact("tester.pl", "792159500").setPassword("test123");
        LoggedUserPage loggedUserPage = new SignUpPage(driver).setSubmitBtn();
        WebElement emailAlert = signUpPage.emailAlert;
        Assert.assertTrue(emailAlert.isDisplayed());
